...
from app.platform.rbac import EXEMPT_PATHS, PERMISSION_RULES, RBACMiddleware
from app.platform.telemetry import setup_observability

logger = logging.getLogger(__name__)

app = FastAPI(title="KaiOps API", version="1.0.0")
app.add_middleware(RBACMiddleware, permission_rules=PERMISSION_RULES, exempt_paths=EXEMPT_PATHS)
